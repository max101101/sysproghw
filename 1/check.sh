...
python generator.py -f test5.txt -c 100000 -m 100000
python generator.py -f test6.txt -c 100000 -m 100000
gcc main.c
./a.out 10000 test1.txt test2.txt test3.txt test4.txt test5.txt test6.txt
